...
public class PGEditSeekbarLayout extends LinearLayout {
    ...
    protected void init() {
        LayoutInflater.from(getContext().getApplicationContext())
                .inflate(EUExUtil.getResLayoutID("pg_sdk_edit_seekbar_layout"), this, true);
    }
    ...
    protected void onFinishInflate() {
        ...
        mSeekBarParentView = findViewById(EUExUtil.getResIdID("seekbar_parent"));
        mBottomView = findViewById(EUExUtil.getResIdID("bottom"));
    }
    ...
    public void showWithAnimation() {
        ...
        float bottomHeight = getContext().getResources().getDimension(EUExUtil.getResDimenID("pg_sdk_edit_second_bottom_down_height"));
