...
public class PGEditCompareGLSurfaceView extends RelativeLayout
    ...
    private void init(Context context) {
        LayoutInflater.from(context).inflate(EUExUtil.getResLayoutID("pg_sdk_edit_compare_pgglsurfaceview"), this, true);
        mPGGLSurfaceView = (PGGLSurfaceView) findViewById(EUExUtil.getResIdID("glsurfaceview"));
        mImageView = (ImageLoaderView) findViewById(EUExUtil.getResIdID("compare_imageview"));
