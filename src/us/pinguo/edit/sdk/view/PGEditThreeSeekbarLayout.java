...
public class PGEditThreeSeekbarLayout extends PGEditSeekbarLayout {
    ...
    protected void init() {
        LayoutInflater.from(getContext().getApplicationContext())
                .inflate(EUExUtil.getResLayoutID("pg_sdk_edit_three_seekbar_layout"), this, true);
    }
    ...
    protected void onFinishInflate() {
        ...
        centerView = (TextView) findViewById(EUExUtil.getResIdID("center_tv"));
        leftView = (TextView) findViewById(EUExUtil.getResIdID("left_tv"));
        rightView = (TextView) findViewById(EUExUtil.getResIdID("right_tv"));
    }
