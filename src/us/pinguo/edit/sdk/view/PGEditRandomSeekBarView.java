...
public class PGEditRandomSeekBarView implements View.OnClickListener, IPGEditRandomSeekBarView {
    ...
    public void initView(Activity activity) {
        mSeekLayout = (PGEditSeekbarLayout) activity.findViewById(EUExUtil.getResIdID("lighting_seekbar_layout"));
        mSeekBar = (PGEditSeekBar) mSeekLayout.findViewById(EUExUtil.getResIdID("seek_bar"));
        ...
        mRandomView = mSeekLayout.findViewById(EUExUtil.getResIdID("random"));
