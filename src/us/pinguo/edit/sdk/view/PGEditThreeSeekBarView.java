...
public class PGEditThreeSeekBarView implements View.OnClickListener, IPGEditThreeSeekBarView {
    ...
    public void initView(Activity activity) {
        mThreeSeekbarLayout = (PGEditThreeSeekbarLayout) activity.findViewById(EUExUtil.getResIdID("three_seekbar_layout"));

        mCancelBtn = mThreeSeekbarLayout.findViewById(EUExUtil.getResIdID("cancel"));
        mCancelBtn.setOnClickListener(this);

        mConfirmBtn = mThreeSeekbarLayout.findViewById(EUExUtil.getResIdID("confirm"));
        mConfirmBtn.setOnClickListener(this);

        mSeekBar = (PGEditSeekBar) mThreeSeekbarLayout.findViewById(EUExUtil.getResIdID("seek_bar"));
