...
public class PGEditView implements IPGEditView {
    ...
    public void initView(Activity activity) {
        activity.setContentView(EUExUtil.getResLayoutID("pg_sdk_edit_main"));
        mCompareGLSurfaceView = (IPGEditCompareGLSurfaceView) activity.findViewById(EUExUtil.getResIdID("compare_view"));
        mCompareGLSurfaceView.getPGGLSurfaceView().setListener(mPGGLListener);

        mBannerView = activity.findViewById(EUExUtil.getResIdID("pg_sdk_edit_banner"));
        mBannerView.setOnClickListener(mOnClickListener);

        mFirstHorizontalLayout = (LinearHoriScrollView) activity.findViewById(EUExUtil.getResIdID("first_menus"));
        mSecondHorizontalLayout = (LinearHoriScrollView) activity.findViewById(EUExUtil.getResIdID("second_menus"));
        mSecondMenusLayout = activity.findViewById(EUExUtil.getResIdID("second_menus_layout"));

        mThirdHorizontalLayout = (LinearHoriScrollView) activity.findViewById(EUExUtil.getResIdID("third_menus"));

        mFirstTopView = activity.findViewById(EUExUtil.getResIdID("first_top"));
        mStepLayout = activity.findViewById(EUExUtil.getResIdID("step_layout"));
        mSaveEffectView = activity.findViewById(EUExUtil.getResIdID("save_effect"));
        mSaveEffectView.setOnClickListener(mOnClickListener);

        mBackMainView = activity.findViewById(EUExUtil.getResIdID("back_main"));
        mBackMainView.setOnClickListener(mOnClickListener);

        mQuitView = activity.findViewById(EUExUtil.getResIdID("quit"));
        mQuitView.setOnClickListener(mOnClickListener);

        mSavePhotoView = activity.findViewById(EUExUtil.getResIdID("save_photo"));
        mSavePhotoView.setOnClickListener(mOnClickListener);

        mCenterLayout = (ViewGroup) activity.findViewById(EUExUtil.getResIdID("center_layout"));
        mCenterLayoutParent = activity.findViewById(EUExUtil.getResIdID("center_layout_parent"));

        mProgressDialogView = activity.findViewById(EUExUtil.getResIdID("progress_dialog"));

        mLastStepView = activity.findViewById(EUExUtil.getResIdID("last_step"));
        mLastStepView.setOnClickListener(mOnClickListener);
        mLastStepView.setEnabled(false);

        mNextStepView = activity.findViewById(EUExUtil.getResIdID("next_step"));
        mNextStepView.setOnClickListener(mOnClickListener);
        mNextStepView.setEnabled(false);

        mNameAutoHideTextView = (PGEditAutoHideTextView) activity.findViewById(EUExUtil.getResIdID("name_auto_hide_textview"));
        mValueAutoHideTextView = (PGEditAutoHideTextView) activity.findViewById(EUExUtil.getResIdID("value_auto_hide_textview"));
        mSecondBottomName = (TextView) activity.findViewById(EUExUtil.getResIdID("second_bottom_name"));

        mEffectBackView = activity.findViewById(EUExUtil.getResIdID("effect_back"));
        mActivity = activity;
    }
    ...
    public void toastFailForSdCard(Context context, boolean hasSD) {
        if (hasSD) {
            Toast.makeText(context, EUExUtil.getResStringID("pg_sdk_edit_no_free_space"), Toast.LENGTH_LONG).show();
        } else {
            Toast.makeText(context, EUExUtil.getResStringID("pg_sdk_edit_no_storage"), Toast.LENGTH_LONG).show();
        }
    }

    public void toastFirstFail(Context context) {
        Toast toast = Toast.makeText(context, EUExUtil.getResStringID("pg_sdk_edit_first_show_fail"), Toast.LENGTH_LONG);
    ...
    public void toastMakePhotoFail(Context context) {
        Toast.makeText(context, EUExUtil.getResStringID("pg_sdk_edit_make_photo_fail"), Toast.LENGTH_LONG).show();
    }
    ...
    public void moveTopAndCenterToUpWithAnimation() {
        if (Build.VERSION.SDK_INT >= 11) {
            float centerMoveHeight = mActivity.getResources().getDimension(
                    EUExUtil.getResDimenID("pg_sdk_edit_center_move_top_height"));
            ...
            float topHeight = mActivity.getResources().getDimension(EUExUtil.getResDimenID("pg_sdk_edit_top_height"));
            ...
            int centerMoveHeight = Math.round(mActivity.getResources().getDimension(EUExUtil.getResDimenID("pg_sdk_edit_center_move_top_height")));
    ...
    public void showBottomSecondMenuWithAnimation() {
        ...
        if (Build.VERSION.SDK_INT >= 11) {
            float secondBottomHeight = mActivity.getResources().getDimension(EUExUtil.getResDimenID("pg_sdk_edit_second_bottom_height"));
            ...
            float bottomHeight = mActivity.getResources().getDimension(EUExUtil.getResDimenID("pg_sdk_edit_bottom_height"));
    ...
    public void backTopAndCenterWithAnimation() {
        ...
        if (Build.VERSION.SDK_INT >= 11) {
            float centerHeight = mActivity.getResources().getDimension(EUExUtil.getResDimenID("pg_sdk_edit_center_move_top_height"));
    ...
    public View getEffectTypeItem(View view) {
        return view.getRootView().findViewById(EUExUtil.getResIdID("effect_type_item_root"));
    }

    public EffectTypeMaskView getEffectTypeMask(View view) {
        return (EffectTypeMaskView) view.findViewById(EUExUtil.getResIdID("effect_type_mask"));
    }
    ...
    public void showFirstImageViewPhoto(List mPGEditMenusBeanList, float showCount, View.OnClickListener onClickListener) {
        ...
        mActivity.findViewById(EUExUtil.getResIdID("step_layout")).setVisibility(View.VISIBLE);
        mActivity.findViewById(EUExUtil.getResIdID("first_top")).setVisibility(View.VISIBLE);
    ...
    private class SaveTipsDialog extends Dialog {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            descView.setText(mActivity.getString(EUExUtil.getResStringID("pg_sdk_edit_quit_edit")));
            ...
            confirmButton.setText(mActivity.getString(EUExUtil.getResStringID("pg_sdk_edit_ok")));
            ...
            closeButton.setText(mActivity.getString(EUExUtil.getResStringID("pg_sdk_edit_quit")));
