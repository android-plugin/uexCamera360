...
public class PGEditMenuItemView extends RelativeLayout
    ...
    protected void init(Context context){
        ...
        mIconImageView = (ImageView) findViewById(EUExUtil.getResIdID("icon"));
        mNameTextView = (TextView) findViewById(EUExUtil.getResIdID("name"));

        mScrollView = (ImageView) findViewById(EUExUtil.getResIdID("effect_scroll"));
        setOnClickListener(this);

        mDownLineView = findViewById(EUExUtil.getResIdID("down_line"));
        mDividerView = findViewById(EUExUtil.getResIdID("divider"));

        mDeleteView = (ImageView) findViewById(EUExUtil.getResIdID("delete_view"));
    ...
    protected int getLayoutResources(Context context){
        return EUExUtil.getResLayoutID("plugin_uexcamera360_menu_item");
    }
