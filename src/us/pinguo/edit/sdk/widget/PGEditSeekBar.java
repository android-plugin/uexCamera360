...
public class PGEditSeekBar extends View {
    ...
    public PGEditSeekBar(Context context, AttributeSet attrs) {
        ...
        mThumbRadius = context.getResources().getDimension(EUExUtil.getResDimenID("seekbar_thumb_radius"));
        mNailRadius = context.getResources().getDimension(EUExUtil.getResDimenID("seekbar_nail_radius"));
        mNailStrokeWidth = context.getResources().getDimension(EUExUtil.getResDimenID("seekbar_nail_stroke_width"));
        mLineWidth = context.getResources().getDimension(EUExUtil.getResDimenID("seekbar_line_width"));
        init();
    }
