...
public class PGEditEffectTypeHoriScrollItemAdapter extends BaseHoriScrollItemAdapter {
    ...
    public View initView(LinearHoriScrollView parent, Context context, int position) {
        ...
        View itemView = View.inflate(mContext, EUExUtil.getResLayoutID("plugin_uexcamera360_layout_effect_type_item"), null);
        ImageLoaderView icon = (ImageLoaderView) itemView.findViewById(EUExUtil.getResIdID("effect_type_image"));
        TextView text = (TextView) itemView.findViewById(EUExUtil.getResIdID("effect_type_text"));
        View colorBar = itemView.findViewById(EUExUtil.getResIdID("effect_type_color_bar"));
        icon.setScaleType(ImageView.ScaleType.FIT_XY);
        itemView.setTag(dispInfo);
        itemView.setOnClickListener(mOnItemViewClickListener);

        EffectTypeMaskView effectTypeMaskView = (EffectTypeMaskView) itemView.findViewById(EUExUtil.getResIdID("effect_type_mask"));
