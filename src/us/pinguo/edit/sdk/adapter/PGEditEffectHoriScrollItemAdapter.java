...
public class PGEditEffectHoriScrollItemAdapter extends PGEditEffectSelectAdapter {
    ...
    private View.OnClickListener mOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            View effectState = v.findViewById(EUExUtil.getResIdID("effect_state_parent"));
            if (effectState.getVisibility() == View.VISIBLE) {
                ...
                if (mLastSelectedView != null) {
                    mLastSelectedView.findViewById(EUExUtil.getResIdID("effect_state_parent")).setVisibility(View.INVISIBLE);
                }
    ...
    public View initView(LinearHoriScrollView parent, Context context, int position) {
        ...
        if (isShowFirstPosition && position == 0) {
            item = View.inflate(context, EUExUtil.getResLayoutID("plugin_uexcamera360_layout_effect_select_empty"), null);
        } else {
            ...
            ImageView maskImageView = (ImageView) item.findViewById(EUExUtil.getResIdID("effect_mask"));
            View effectStateParent = item.findViewById(EUExUtil.getResIdID("effect_state_parent"));

            //隐藏掉特效选中状态
            item.findViewById(EUExUtil.getResIdID("effect_selected")).setVisibility(View.GONE);
            ...
            if (mLastSelectedView != null) {
                ...
                if (lastEffect.eft_key.equals(effect.eft_key)) {
                    item.findViewById(EUExUtil.getResIdID("effect_state_parent")).setVisibility(View.VISIBLE);
